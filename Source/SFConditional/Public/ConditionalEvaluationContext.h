...
#include "ConditionalEvaluationContext.generated.h"
...
namespace SF
{
	...
	struct SFCONDITIONAL_API FConditionalEvaluationContext
	{
		GENERATED_BODY()

		FConditionalEvaluationContext() = default;

		FConditionalEvaluationContext(UObject* InTestObject, UObject* InInstigator = nullptr,
		                                FConditionalDebugTrace* InOptionalDebugTrace = nullptr) :
		...
		FORCEINLINE FConditionalDebugTrace* TryGetDebugTrace() const { return OptionalDebugTrace; }
	...
	template <typename TReturnClass>
	TReturnClass* FConditionalEvaluationContext::TryGetTestObjectActorComponent() const
	{
	...
	template <typename TReturnClass>
	TReturnClass* FConditionalEvaluationContext::TryGetInstigatorActorComponent() const
	{
